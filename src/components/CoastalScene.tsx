      ...
      <svg viewBox="0 0 375 200" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" style={{ display: 'block' }}>
        ...
        <g clipPath="url(#cs-clip)">
          ...
          {/* Reef rocks — rendered AFTER boats so boats drift behind the
              ...
              Bottom edge at y=142 (10px below the waterline) — small rocky
              outcropping, not a slab. */}
          <path d={`M12,142 L12,${WL} L18,${WL-1} L24,${WL-1} L30,${WL-2} L38,${WL-2} L44,${WL-2} L52,${WL-2} L60,${WL-2} L66,${WL-1} L72,${WL-1} L78,${WL-1} L84,${WL} L90,${WL-1} L94,${WL} L94,142Z`} fill={rC} />
          <path d={`M16,142 L16,${WL} L22,${WL} L28,${WL-1} L36,${WL-1} L44,${WL-1} L52,${WL-2} L60,${WL-1} L66,${WL-1} L72,${WL-1} L78,${WL} L84,${WL} L90,${WL} L92,${WL} L92,142Z`} fill={rM} />
          <path d={`M22,142 L22,${WL} L30,${WL} L38,${WL-1} L46,${WL-1} L52,${WL-1} L58,${WL-1} L64,${WL-1} L70,${WL} L76,${WL} L82,${WL} L86,142Z`} fill={rD} />
